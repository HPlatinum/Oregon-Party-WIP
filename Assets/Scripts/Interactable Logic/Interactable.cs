...
{
    public enum InteractTypes { Pickup, Fishing, Chest, CookingTier1, CookingTier2, Woodcutting, Mining, Forge, SharpeningStation, Deposit, Log, Beaver, Vehicle, Scrapping };
